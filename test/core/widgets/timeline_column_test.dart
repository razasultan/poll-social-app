...
void main() {
  ...
  testWidgets('constrains content to maxWidth and centers it on wide viewports', (
    tester,
  ) async {
  ...
  testWidgets('fills the available width with no centering on narrow viewports', (
    tester,
  ) async {
